...
train_y = labels_age[0:nbtrain]
test_x = train_image[nbtrain:, :, :, :]
test_y = labels_age[nbtrain:]
...
label = tf.placeholder(tf.float32, shape=[None, class_num_age])
        ...
        for step in range(iteration):
            ...
            if step == iteration - 1:
                ...
                with open('logs-age.txt', 'a') as f:
                    f.write(line)
        saver.save(sess=sess, save_path='./model-age/dense_age.ckpt')